...
#define CONFIG_EXAMPLES_DIR "Tevo/Tornado/V2 (MKS GEN-L)" // La carte installé est une SGEN-L
...
#define STRING_CONFIG_H_AUTHOR "(fran6p, Tevo Tornado V2 MKS SGEN-L)" // Who made the changes.
