...
//#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //Test 
#define X_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
//#define Z_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. //Test
//#define Z_MIN_PROBE_ENDSTOP_INVERTING true // Set to true to invert the logic of the probe. //Test

// Test suggestion David PHAM-VAN
#if ENABLED(BLTOUCH)
...
#define ENDSTOP_INTERRUPTS_FEATURE //FP test
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 } // Modification pas E de 93 à 140 (BMG sans réduction) puis de 140 à 415 pour extrudeur BMG 3:1 avec Flying Extruder
 ...
 */
//#define CLASSIC_JERK
#define CLASSIC_JERK // Junction deviation pas encore au point sur les cartésiennes
...
#define INVERT_E0_DIR false // BMG 3:1 => inversion sens rotation (=true)
