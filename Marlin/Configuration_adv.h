...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  35, 40 }, { 275,  40 }, { 275, 280 }, { 35, 280 } }
 ...
 */
//#define LIN_ADVANCE
//#define LIN_ADVANCE // Test FP A eviter avec CM Creality silencieuses
...
#define G29_RETRY_AND_RECOVER
  ...
  #define G29_SUCCESS_COMMANDS "M117 Nivellement du lit fait."
  #define G29_RECOVER_COMMANDS "M117 Echec de la sonde. \nG28\n"
  #define G29_FAILURE_COMMANDS "M117 Echec nivellement du lit.\nG0 Z10\nM300 P25 S880\nM300 P50 S0\nM300 P25 S880\nM300 P50 S0\nM300 P25 S880\nM300 P50 S0\nG4 S1"
...
#define RX_BUFFER_SIZE 1024 //FP test

#if RX_BUFFER_SIZE >= 1024
  // Enable to have the controller send XON/XOFF control characters to
  // the host to signal the RX buffer is becoming full.
  #define SERIAL_XON_XOFF //FP test
#endif
...
//#define CUSTOM_USER_MENUS
  ...
  #define CUSTOM_USER_MENU_TITLE "Nivellement"
  //#define USER_SCRIPT_DONE "M117 Script utilisateur fini"
  #define USER_SCRIPT_AUDIBLE_FEEDBACK
  #define USER_SCRIPT_RETURN  // Return to status screen after a script

  #define USER_DESC_1 "Setup Zoffset"
  #define USER_GCODE_1 "M190S55\nG28\nG29\nM400\nM104S215\nG28\nM109S215\nM420S1\nG1X150Y150F5000\nG1Z0\nM500\nM117 Effectuer Offset Z"

  #define USER_DESC_2 "PID Hotend"
  #define USER_GCODE_2 "M106S128\nM303C8S215E0U\nM500\nM117 PID Hotend fini"

  #define USER_DESC_3 "Ajuster Z"
  #define USER_GCODE_3 "M190S55\nM104S200\nG28\nG29L1\nG1 X150Y150F5000\nG1Z0"

  #define USER_DESC_4 "Enregistrer reglages"
  #define USER_GCODE_4 "M500\nM117 Enregistrement fait"

  #define USER_DESC_5 "Test validation maillage"
